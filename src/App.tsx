...
function App() {
  ...
  const { state: voiceState, isSupported: voiceSupported, toggle: toggleVoice } = useVoiceInput({
    lang: fromLang,
    ...
    <div className="app">
      ...
      <footer className="input-area">
        ...
        <div className="input-actions">
          {voiceSupported && (
            <button
              className={`mic-btn${voiceState === 'listening' ? ' mic-btn--active' : ''}${voiceState === 'error' ? ' mic-btn--error' : ''}`}
              onClick={toggleVoice}
              aria-label={voiceState === 'listening' ? 'Stop recording' : 'Start voice input'}
              title={voiceState === 'listening' ? 'Stop recording' : 'Speak to fill input'}
              type="button"
            >
